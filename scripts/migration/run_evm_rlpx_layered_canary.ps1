...
try {
    ...
    $md.Add("- no real blockAccessListHash metadata source")
    ...
    $md.Add("- No eth_baseFee, blockAccessListHash, eth/71 guard, BAL fallback, UA RocksDB, or plugin architecture behavior is changed.")
    $md.Add("")
    $md.Add("Merge Note:")
