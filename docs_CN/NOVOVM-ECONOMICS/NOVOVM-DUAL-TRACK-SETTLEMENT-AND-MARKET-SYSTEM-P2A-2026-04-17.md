...
11. oracle 不能单独决定价格，只能参与 `weighted_median`、偏离检测、熔断和兜底；fee quote / 非 NOV 支付路径不得在协议清算价拒绝 oracle-only 或 no-anchor 资产后回退到直接 oracle 报价。
