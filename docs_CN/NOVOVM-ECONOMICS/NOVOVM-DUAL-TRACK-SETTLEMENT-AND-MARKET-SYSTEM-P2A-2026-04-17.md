...
- Treasury reserve proof effective-status gate 已接入非 NOV 资产路径：如果某资产已登记 reserve proof 且 effective status 非 `active`，该资产不能继续用于 fee clearing，也不能从 Treasury redeem 出库；缺失 proof 仍保持 non-claim，不被误写成自动外部验真。
