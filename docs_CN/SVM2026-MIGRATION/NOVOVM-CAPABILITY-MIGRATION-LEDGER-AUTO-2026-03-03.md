...
- generated_at_utc: 2026-03-04T18:46:15.1810631Z
...
| D3 Consensus Network Domain | InProgress | F-05/F-06/F-07/F-08 = ReadyForMerge | F-05=ReadyForMerge, F-06=ReadyForMerge, F-07=ReadyForMerge, F-08=InProgress |
...
| F-05 | Consensus engine | ReadyForMerge | consensus=True, batch_a=True, consensus_negative.enabled=True, consensus_negative.available=True, consensus_negative.pass=True, weighted_quorum=False, equivocation=False, view_change=False, fork_choice=False |
...
| F-07 | Network layer | ReadyForMerge | network=True, process=True, block_wire=True, block_wire_negative=False |
...
| F-07 | Network layer (core-complete, production hardening pending) | ReadyForMerge | novovm-network skeleton + network_output_signal(pass=True) + network_closure_signal(pass=True) + network_process_signal(pass=True, mode=mesh, rounds=1/1, round_ratio=1, nodes=2, pairs=1/1, ratio=1, directed=2/2:1, block_wire=True(2/2:1), block_wire_round_ratio=1) + network_block_wire_negative(enabled=false) are available | D:\WEB3_AI\SUPERVM\artifacts\migration\functional\functional-consistency.json | 2026-03-05 |
