...
|---|---|---|---|---:|---:|---:|---:|---:|---:|
| core_only | none | none | core | 32 | 1 | 1 | 205781.7 | 205781.7 | 205781.7 |

## Stage P50 (ms)

| profile | mempool_ms_p50 | adapter_ms_p50 | aoem_submit_ms_p50 | batch_a_ms_p50 | network_ms_p50 | stage_total_ms_p50 |
|---|---:|---:|---:|---:|---:|---:|
| core_only | 49.6 | 232.56 | 16.42 | 1990.4 | 0.71 | 2385.04 |

## Overhead P50

| profile | non_engine_pct_p50 | bootstrap_ms_p50 |
|---|---:|---:|
| core_only | 99.31 | 44.72 |

## Reproduce

```powershell
& scripts/migration/run_tx_e2e_tps_core_sidecar_report.ps1 -RepoRoot D:\WEB3_AI\SUPERVM -Repeats 1 -Txs 500000 -Accounts 65536 -TimeoutSec 1800 -BatchCount 256 -IngressWorkers 32 -AdapterSignalMode fast -Profiles 'core_only' -AoemPluginDir D:\WEB3_AI\SUPERVM\aoem\plugins -BuildProfile release
```

## Artifacts

- d:\WEB3_AI\SUPERVM\artifacts\migration\tx-e2e-tps-core-sidecar-2026-03-08-scale500k\tx-e2e-tps-summary.json
- d:\WEB3_AI\SUPERVM\docs_CN\AOEM-FFI\AOEM-FFI-CORE-SIDECAR-E2E-TX-TPS-RAW-2026-03-08-SCALE-500K.csv
