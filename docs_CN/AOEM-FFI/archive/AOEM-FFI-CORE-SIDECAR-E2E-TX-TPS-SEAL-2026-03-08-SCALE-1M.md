...
|---|---|---|---|---:|---:|---:|---:|---:|---:|
| core_only | none | none | core | 32 | 1 | 1 | 146330.03 | 146330.03 | 146330.03 |

## Stage P50 (ms)

| profile | mempool_ms_p50 | adapter_ms_p50 | aoem_submit_ms_p50 | batch_a_ms_p50 | network_ms_p50 | stage_total_ms_p50 |
|---|---:|---:|---:|---:|---:|---:|
| core_only | 102.61 | 474.51 | 32.81 | 5979.17 | 0.79 | 6771.51 |

## Overhead P50

| profile | non_engine_pct_p50 | bootstrap_ms_p50 |
|---|---:|---:|
| core_only | 99.52 | 62.36 |

## Reproduce

```powershell
& scripts/migration/run_tx_e2e_tps_core_sidecar_report.ps1 -RepoRoot D:\WEB3_AI\SUPERVM -Repeats 1 -Txs 1000000 -Accounts 131072 -TimeoutSec 1800 -BatchCount 512 -IngressWorkers 32 -AdapterSignalMode fast -Profiles 'core_only' -AoemPluginDir D:\WEB3_AI\SUPERVM\aoem\plugins -BuildProfile release
```

## Artifacts

- d:\WEB3_AI\SUPERVM\artifacts\migration\tx-e2e-tps-core-sidecar-2026-03-08-scale1m\tx-e2e-tps-summary.json
- d:\WEB3_AI\SUPERVM\docs_CN\AOEM-FFI\AOEM-FFI-CORE-SIDECAR-E2E-TX-TPS-RAW-2026-03-08-SCALE-1M.csv
