...
> 最新能力透明口径请同时参考：`AOEM-FFI-CAPABILITY-TRANSPARENCY-MATRIX-2026-03-15.md`

## 当前唯一版本
- AOEM release version: `Beta 0.8`
- AOEM fullmax stamp: `20260312-103055`

## 产物来源
- AOEM Windows fullmax:
  - `D:\WEB3_AI\AOEM\artifacts\ffi-bundles\fullmax\windows\20260312-103055`
- AOEM Linux fullmax:
  - `D:\WEB3_AI\AOEM\artifacts\ffi-bundles\fullmax\linux\20260312-103055`
...
- 能力契约快照:
  ...
  - `groth16_verify_full_gpu=true`
  - `groth16_verify_full_gpu_kernel=groth16_bls12_381_pairing_miller_full_gpu_v1`
  - `groth16_verify_full_gpu_reason_code=pairing_miller_gpu_bridge_enabled`

## 清理策略
- 历史 AOEM fullmax bundle 仅保留 `20260312-103055`。
- SuperVM 迁移记录仅保留：
