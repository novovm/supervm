...
- 本轮真实主网产品入口 follow-up 从 `current=1077/highest=25274898` 推进到 `current=1101/highest=25274961`；期间 block `1093` 出现 mid-body remote close 后由 missing-body recovery 恢复，block `1101` 保留了非空 ommer body material 和 receipt snapshot。
