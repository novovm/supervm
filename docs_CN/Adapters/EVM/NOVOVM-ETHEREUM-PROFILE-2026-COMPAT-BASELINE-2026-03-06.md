# NOVOVM Ethereum Profile 2026 兼容基线（EVM Persona）- 2026-03-06

## 1. 目标

定义 2026 年 EVM Persona 的最低兼容基线，用于指导 profile 配置、门禁优先级与上线范围。

说明：

- 外部网络升级时间点以以太坊官方公告为准。
- 本文件不固化具体激活日期，只定义必须覆盖的兼容能力面。
...
| M2 | 高级兼容 | tracing、高级运维兼容、更多 profile 差异化治理 |
