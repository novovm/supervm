...
1. 已接入第一份官方 geth address fixture 子集和第一份官方 EIP-1559 sender balance state fixture 子集；如要继续提高执行语义置信度，下一步接 SLOAD warm/cold 或 SSTORE refund cap 官方 state fixture 子集。
