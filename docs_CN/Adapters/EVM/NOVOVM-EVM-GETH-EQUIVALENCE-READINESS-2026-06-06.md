...
1. 已接入第一份官方 geth address fixture 子集；如要继续提高执行语义置信度，下一步接 Ethereum execution-spec state fixture 子集，优先选账户余额 edge、CREATE/CALL failure edge、CREATE/CREATE2 collision edge、SSTORE refund cap edge、SLOAD warm/cold edge 和 EIP-1559 fee edge 样本。
