...
pub const REQUIRED_GATE_KEYS_IN_ORDER: [&str; 51] = [
    ...
    "test_native_nonce_identity_v2",
    "test_native_nonce_checkpoint_bundle",
    "test_native_nonce_upgrade_staging",
    "test_native_nonce_upgrade_authorization",
    "test_native_nonce_source_qc",
    "test_native_seal_new_view",
    "test_native_seal_new_view_admission",
    "test_product_mainline_overlay_lifecycle",
